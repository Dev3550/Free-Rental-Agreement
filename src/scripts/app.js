...
const countryConfigs = {
  ...
  US: {
    ...
    landlordIdLabel: 'Driver License / State ID / Tax Ref *',
    tenantIdLabel: 'Driver License / State ID / Passport *',
    defaultLandlordId: 'DL: CA-9876543',
    defaultTenantId: 'DL: CA-1234567',
  ...
  UK: {
    ...
    landlordIdLabel: 'UK Passport / Identity Ref *',
    tenantIdLabel: 'UK Passport / BRP Card Number *',
    defaultLandlordId: 'ID: UK-98765432',
    defaultTenantId: 'ID: UK-12345678',
  ...
  UAE: {
    ...
    landlordIdLabel: 'Emirates ID / Passport Number *',
  ...
  CA: {
    ...
    landlordIdLabel: 'Driver License / Provincial Photo ID *',
    tenantIdLabel: 'Driver License / Photo ID *',
    defaultLandlordId: 'ID: ON-9876543',
    defaultTenantId: 'ID: ON-1234567',
